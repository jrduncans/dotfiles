...
def importCatsEffect = {
  repl.load("import $ivy.`org.typelevel::cats-effect:2.0.0`")
  repl.load("import cats.effect._")
}

def importKittens = {
  repl.load("import $ivy.`org.typelevel::kittens:2.0.0`")
}

def importMouse = {
  repl.load("import $ivy.`org.typelevel::mouse:0.23`")
  repl.load("import mouse.all._")
}

def importCirce = {
  repl.load("import $ivy.`io.circe::circe-core:0.12.1`")
  repl.load("import $ivy.`io.circe::circe-generic:0.12.1`")
...
def importMonocle = {
  repl.load("import $ivy.`com.github.julien-truffaut::monocle-core:2.0.0`")
  repl.load("import $ivy.`com.github.julien-truffaut::monocle-macro:2.0.0`")
