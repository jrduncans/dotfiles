...
def importCirce = {
  repl.load("import $ivy.`io.circe::circe-core:0.11.1`")
  repl.load("import $ivy.`io.circe::circe-generic:0.11.1`")
  repl.load("import $ivy.`io.circe::circe-generic-extras:0.11.1`")
  repl.load("import $ivy.`io.circe::circe-parser:0.11.1`")
