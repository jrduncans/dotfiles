...
def importCatsFree = {
  repl.load("import $ivy.`org.typelevel::cats-free:1.4.0`")
  repl.load("import cats.free._")
}

def importCatsEffect = {
  repl.load("import $ivy.`org.typelevel::cats-effect:1.0.0`")
  repl.load("import cats.effect._")
}

def importKittens = {
  repl.load("import $ivy.`org.typelevel::kittens:1.1.1`")
}

def importMouse = {
  repl.load("import $ivy.`org.typelevel::mouse:0.19`")
  repl.load("import mouse.all._")
}

def importCirce = {
  repl.load("import $ivy.`io.circe::circe-core:0.10.0`")
  repl.load("import $ivy.`io.circe::circe-generic:0.10.0`")
  repl.load("import $ivy.`io.circe::circe-generic-extras:0.10.0`")
  repl.load("import $ivy.`io.circe::circe-parser:0.10.0`")
